...
namespace Microsoft.Dafny {
  public class CheckUnderspecification : ResolverPass {
    public CheckUnderspecification(Resolver resolver)
      : base(resolver)
    {
    }
  ...
  public class DetectUnderspecificationVisitor : BottomUpVisitor {
    private readonly CheckUnderspecification cus;
    private readonly ICodeContext codeContext;

    public DetectUnderspecificationVisitor(CheckUnderspecification cus, ICodeContext codeContext) {
